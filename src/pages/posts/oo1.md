...
- **Facturar un conjunto de órdeness:** dada una klista de órdenes, se retornan las facturas correspondientes a cada una de ellas. En cada factura debe quedar registrada la fecha, la patente del vehículo, el monto final y el descuento. El monto final se calcula en base a un costo y un incremento de ganancia según el caso:
